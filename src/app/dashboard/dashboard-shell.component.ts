...
@Component({
  ...
  template: `
    <app-dashboard>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 px-2 sm:px-4 md:px-8 py-2 md:py-4 min-w-0">
        <!-- Column 1: Patient List -->
        <div class="mb-4 lg:mb-0 overflow-x-auto min-w-0 flex flex-col">
        ...
        <div class="space-y-6 overflow-x-auto min-w-0 flex flex-col">
